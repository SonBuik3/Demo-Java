...
public class MapGenerator {
    ...
    public void draw(Graphics2D g) { //vẽ bản đồ lên đối tượng Graphics2D, 
    	                             //với mỗi viên gạch có giá trị lớn hơn 0, sử dụng màu đỏ để vẽ hình chữ nhật và đường viền đen bao quanh.
